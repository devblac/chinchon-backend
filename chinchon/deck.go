...
//
// So essentially it's a sort order for the cards, according to Spanish card game rules.
// This is used for both Truco and Chinchón as they use the same deck and ranking.
//
